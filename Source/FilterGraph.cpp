...
File FilterGraph::getLastDocumentOpened()
{
	...
	recentFiles.restoreFromString("booger");// getAppProperties().getUserSettings() //greg1
...
{
    RecentlyOpenedFilesList recentFiles;
	recentFiles.restoreFromString("fooger");// getAppProperties().getUserSettings()
                                        //->getValue ("recentFilterGraphFiles"));//greg1

    recentFiles.addFile (file);

   // getAppProperties().getUserSettings() //greg1
